...
- Demonstrate feasibility for a full production rollout.
- Provide stakeholders with clear visibility into scope, schedule, and budget.
- Regain Uniworld's position as a dominant player in the global market.
- Evaluate the effectiveness of the prototype website in driving sales and enhancing customer engagement.

### Project Objectives & Success Metrics
- Deliver a functional prototype within **11 weeks**.
...
- Prototype design (catalog, cart, checkout flow)
- Integration of features for product browsing, ordering, and fulfillment
...
### **Quality Issues and Defect Level**
- **Reason:** Insufficient attention to quality standards resulted in a higher-than-anticipated defect level.
- **Impact & Deviation:** Required the additional task "Emergency Defect Corrections" to address quality issues, causing a delay in project progress.

### **Addition of Emergency Task 9**
...
- **Communication Gaps:** Ineffective communication and collaboration resulting from missed meetings hindered decision-making and alignment with project objectives.
- **Team Attrition:** Loss of key team members (Tea Dominique) delayed project timelines, affected project quality, and increased the workload on remaining team members.
- **Knowledge Loss & Skill Gaps:** These impeded the successful completion of project tasks (e.g., Adam Herrez being placed on other tasks).

### **Strategies Employed**
- **Proactive Absenteeism Management:** Implemented flexible work arrangements, provided support for health and wellness, and offered incentives for attendance.
...
| Name | Hourly Rate | Regular Hours | Overtime Hours | Total Project Labor Cost |
| :--- | :--- | :--- | :--- | :--- |
| Adam Herrez | $30.00 | 197.5 | 5 | $5,925.00 |
| Chandra Lake | $42.00 | 44.5 | 3 | $1,869.00 |
...
- **Agility:** Maintain a flexible mindset and be prepared to adjust project plans, timelines, and resource allocations as needed. Embrace change and view challenges as opportunities for growth and improvement.
- **Lessons Learned:** Conduct post-project reviews to identify what worked well and areas for improvement. Use these insights to refine processes, update methodologies, and enhance project management practices for future endeavors.
- **Risk Assessment:** Conduct thorough risk assessments at the outset of the project and continuously monitor and reassess risks throughout its duration. Develop contingency plans for addressing unforeseen challenges.
- **Quality Assurance:** Ensure that quality assurance processes and standards are integrated into every phase of the project, with regular reviews and assessments to identify and address issues promptly.
